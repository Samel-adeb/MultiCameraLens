...
public class MainActivity extends  AppCompatActivity  { 
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		raw.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				isRaw = true;
				if (isRaw) {
					raw.setBackground(new GradientDrawable() { public GradientDrawable getIns(int a, int b, int c, int d) { this.setCornerRadius(a); this.setStroke(b, c); this.setColor(d); return this; } }.getIns((int)10, (int)2, 0xFFFFFFFF, Color.TRANSPARENT));
					jpeg.setBackground(new GradientDrawable() { public GradientDrawable getIns(int a, int b, int c, int d) { this.setCornerRadius(a); this.setStroke(b, c); this.setColor(d); return this; } }.getIns((int)10, (int)0, Color.TRANSPARENT, Color.TRANSPARENT));
				}
				else {
					jpeg.setBackground(new GradientDrawable() { public GradientDrawable getIns(int a, int b, int c, int d) { this.setCornerRadius(a); this.setStroke(b, c); this.setColor(d); return this; } }.getIns((int)10, (int)2, 0xFFFFFFFF, Color.TRANSPARENT));
					raw.setBackground(new GradientDrawable() { public GradientDrawable getIns(int a, int b, int c, int d) { this.setCornerRadius(a); this.setStroke(b, c); this.setColor(d); return this; } }.getIns((int)10, (int)0, Color.TRANSPARENT, Color.TRANSPARENT));
				}
			}
		});
	...
	private void initializeLogic() {
		...
		_drawer_textview1.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/quicksand.ttf"), 1);
		_drawer_deviceName.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/quicksand.ttf"), 1);
		_drawer_model.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/quicksand.ttf"), 1);
		_drawer_apiversion.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/quicksand.ttf"), 1);
		_drawer_androidversion.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/quicksand.ttf"), 1);
		_drawer_textview6.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/quicksand.ttf"), 1);
		_drawer_noCam.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/quicksand.ttf"), 1);
		_drawer_moFrontCam.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/quicksand.ttf"), 1);
		_drawer_noRearCam.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/quicksand.ttf"), 1);
		_drawer_textview10.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/quicksand.ttf"), 1);
		_drawer_compatibility.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/quicksand.ttf"), 1);
		...
		capturedImage.setBackground(new GradientDrawable() { public GradientDrawable getIns(int a, int b, int c, int d) { this.setCornerRadius(a); this.setStroke(b, c); this.setColor(d); return this; } }.getIns((int)10, (int)4, 0xFFFFFFFF, Color.TRANSPARENT));
		snap.setBackground(new GradientDrawable() { public GradientDrawable getIns(int a, int b, int c, int d) { this.setCornerRadius(a); this.setStroke(b, c); this.setColor(d); return this; } }.getIns((int)360, (int)2, 0xFFFFFFFF, Color.TRANSPARENT));
